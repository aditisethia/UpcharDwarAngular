...
export class PatientDashboardHomeComponent implements OnInit{
  ...
  constructor(private appointmentService: AppointmentserviceService,private doctorService :DoctorserviceService) { }
  IMG_URLs = this.doctorService.IMAGE_URL;



  getAppointments(): void {
    this.appointmentService.getAppointmentsByPatientId(1, this.page, this.size)
      .subscribe((data:any)=>{
